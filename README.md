...
WSGI_TARGET - образ для сборки wsgi сервиса<br>
...
#### Tracing
TRACING_EXPORTER_ENDPOINT - эндпоинт для отправки трейсов<br>
OTEL_PYTHON_DJANGO_INSTRUMENT - вкл/выкл трейсинг<br>
